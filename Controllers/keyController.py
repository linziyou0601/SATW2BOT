...
def faqKey(key):
    faqObj = {
        "優惠券": "優惠券可以使用在任何商品上，有10、25、50、80、100、200、300元，每個人綁定帳號後24小時能夠抽一次酷碰券",
        "上架": "任何商品都能夠上架到我們的平台",
        "購買": "在我們的平台上只要還有庫存就能夠購買",
        "商品": "任何商品都能夠上架到我們的平台或是在我們的平台上買到",
        "詐騙": "如果遇到任何詐騙案件請聯絡我們的客服",
        "儲值": "現金能夠儲值成我們的虛擬貨幣",
        "付款": "付款的時候需要驗證您的身份，我們會寄一封信到您註冊時所填的信箱",
        "提領": "能將我們的虛擬貨幣提領到您最初設定的銀行帳戶中"
    }
    return faqObj.get(key, " ")